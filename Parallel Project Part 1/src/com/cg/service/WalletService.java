...
public interface WalletService {
	...
	boolean transactionDetails(String tId, String senderMobileNumber, String receiverMobileNumber, BigDecimal deposit,
			BigDecimal withdraw, BigDecimal fundtransfer);

	List<Transaction> getlast10Transaction(String mobileNumber) throws IdNotExistException;
